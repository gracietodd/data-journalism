...
average_county_pills_per_year <- "https://raw.githubusercontent.com/smussenden/spring20-data-journalism/master/labs/lab_05/data/county_pills_per_year.csv"<-  read_csv(average_county_pills_per_year)
...
by_state_white <- get_acs(geography = "state", 
