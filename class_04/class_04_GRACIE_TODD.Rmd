...
#glimpse and summary for shape of data 
glimpse(baltimore)
summary(baltimore)

#290,908 rows and 42 columns. 
#Zip codes are stores as dbl, but we wouldn't do math on them. The date is stored as chr, but should be stored in another format entirely. 
...
# use the clean_names function in janitor to correct capitalization 
...
# Newcare Home Health Services located on Sinclair Lane in Baltimore received 6,133,600 pills between 2006 and 2012. The DEA assisted the state of Maryland's efforts in charging the pharmacy with illegally selling hydrocodone online along with other charges in connection with the trafficking. 
...
#McKesson Corporation, headquartered in Texas, sent 58,267,330 pills between 2006-2012. 
```
...
# Professional Pharmacy Service in Sinai Hospital received more shipments from McKesson Corporation than any other pharmacy in Baltimore: 6,254. The pharmacy offers satellite pharmacy services which cover more areas. It s also located in a hospital. 
...
#From 2006-2012 Rite Aid of Maryland, Inc. received the most pills of any pharmacy in Baltimore, with 16,740,590, or 12.52% of all pills sent to the city- which received 133,721,503 total. 
```
...
#There are three different itterations of Rite Aid. They did not group correctly because they were notated differently (one had a period at the end, one had t/a at the end).
